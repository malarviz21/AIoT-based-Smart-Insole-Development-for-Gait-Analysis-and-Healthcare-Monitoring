...
channelNumber = 32
new_channelNumber = 10
total_channelNumber = channelNumber + new_channelNumber
...
outer_points = [(4928.5274/rx,24919.3123/rx),(3494.2252/rx, 24455.2732/rx),(2270.8497/rx, 22995.6598/rx),(1692.5237/rx,21448.7166/rx),(1270.6701/rx,17382.0478/rx),(1591.2788/rx, 13585.3654/rx),(2164.9997/rx, 9400.5777/rx),(2164.9997/rx, 8286.8841/rx),
(1895.0134/rx,6430.7283/rx),(2030.0066/rx, 2515.9269/rx),(3177.4484/rx,997.2539/rx),(4999.8560/rx,322.2881/rx),(6619.7738/rx,558.5261/rx),(7834.7121/rx,3190.8926/rx),(4999.8560/rx,322.2881/rx),(5944.8080/rx,322.2881/rx),
(8070.9502/rx,9029.3466/rx),(8644.6711/rx, 11729.2095/rx),(9353.3850/rx,16420.2216/rx),(9184.6437/rx,19423.8193/rx),(8374.6848/rx,21988.6892/rx),(6451.0324/rx,24553.5592/rx),(2164.9997/rx,9400.5777/rx)
]
...
def dataProcess(data):
    ...
    for i in data:
        if i.isdigit() or i == '.':
            ...
            datapoint = ''
    #         elif p==7:
    #             dataSet.append(float(datapoint)-6)
    #             datapoint = ''
    #         if 7< p <15:
    #             dataSet.append(float(datapoint))
    #             datapoint = ''
    #         elif p==15:
    #             dataSet.append(float(datapoint)-12)
    #             datapoint = ''
    #         elif p>15 and p<23:
    #             dataSet.append(float(datapoint))
    #             datapoint = ''
    #         elif p==23:
    #             dataSet.append(float(datapoint)-72)
    #             datapoint = ''
    #         elif p>23 and p<30:
    #             dataSet.append(float(datapoint))
    #             datapoint = ''
...
def estimate_new_points(specific_coordinates, signal, new_points):
    interpolator = NearestNDInterpolator(specific_coordinates, signal)
    estimated_values = interpolator(new_points)
...
def plotData():
    ...
    if signal:
        # Estimate values for new points
        new_signal = estimate_new_points(specific_coordinates, signal, outer_points)
        
        # Combine old and new points
        combined_coordinates = specific_coordinates +outer_points

        combined_signal = signal + new_signal.tolist()

        dataset1.append(combined_signal)

        # Prepare data for interpolation
        X = np.array(combined_coordinates)
        y = np.array(combined_signal)
        ...
        heatmap = ax.imshow(grid_z.T, extent=[0, background_array.shape[1], 0, background_array.shape[0]], origin='lower', cmap='jet', alpha=0.5, vmin=4 ,vmax=80)
